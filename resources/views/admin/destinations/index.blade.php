...
@section('content')
    <h1 class="text-2xl text-center  font-bold mb-6">Destinații</h1>
    <h2 class="text-2xl text-center  font-bold mb-6">Aici adăugați destinații ( orașe ) pentru rutele dumneavoastra ( inclusiv opriri )</h2>
...
@endif
    <a href="{{ route('admin.destinations.create') }}" class="inline-block mb-6 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Adaugă Destinații</a>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-md text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    <th scope="col" class="px-6 py-3">Destinație</th>
            ...
            <tbody>
                @foreach ($destinations as $destination)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $destination->route_tur }}</td>
                        <td class="px-6 py-4">
                            <a href="{{ route('admin.destinations.edit', $destination) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline ">Modifică</a>
                        </td>
                        <td class="px-6 py-4">
